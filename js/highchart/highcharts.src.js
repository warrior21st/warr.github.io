...
function stableSort(arr, sortFunction) {
	...
	// Add appList to each item
	for (i = 0; i < length; i++) {
		arr[i].ss_i = i; // stable sort appList
	}
	...
	// Remove appList from items
	for (i = 0; i < length; i++) {
		delete arr[i].ss_i; // stable sort appList
	}
}
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		/**
		 * Return the appList of an item in an array, or -1 if not found
		 */
		inArray: $.inArray,
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.highcharts.com/4.0.3/app/canvas-tools.js',
...
/**
 * Get the updated default options. Until 3.0.7, merely exposing defaultOptions for outside app
...
SVGElement.prototype = {
	...
	*/
	...
	add: function (parent) {
		...
		if (parentWrapper.handleZ) { // this element or any of its siblings has a z appList
...
Pointer.prototype = {
	...
	/**
	 * Return the appList in the tooltipPoints array, corresponding to pixel position in
	 * the plot area.
	 */
	getIndex: function (e) {
		var chart = this.chart;
...
Series.prototype = {
	...
	init: function (chart, options) {
		...
		// Sort series according to appList option (#248, #1123, #2456)
...
function StackItem(axis, options, isNegative, x, stackOption) {
	...
	// This will keep each points' extremes stored by series.appList and point appList
	this.points = {};
...
extend(Axis.prototype, {
	...
	remove: function (redraw) {
		...
		each(chart[key], function (axis, i) { // Re-appList, #1706
		...
		while (i--) {
			...
			if (distanceOption > 0) {
				...
				for (j = 0; j < length; j++) {
					...
					// if that slot appList is closer to the edges of the slots, move it
